...
/** Inaccuracies start above good band (see GRADING.md). */
export const CP_INACCURACY = 101;
export const CP_MISS = 100;
...
export function classifyMoveGrade(input: {
  ...
  if (userEvalBeforeCp >= 200 && cpLoss >= CP_MISS) return "miss";
